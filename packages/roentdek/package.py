...
class Roentdek(Package):
    ...
    def install(self, spec, prefix):
        ...
        shutil.copyfile("x86_64-centos7-gcc731/resort64c.h", base_path / "include" / "roentdek" / "resort64c.h")
        shutil.copyfile("x86_64-centos7-gcc731/libResort64c_x64.a", base_path / "lib" / "libResort64c_x64.a")
